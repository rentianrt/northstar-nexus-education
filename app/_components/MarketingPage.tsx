  ...
  en: {
    ...
    mentors: {
      ...
      metrics: [
        ...
        ["11", "TECH & INDUSTRY ORGANIZATIONS"],
        ["06", "EXPERTISE AREAS"],
      ],
      groups: [
        {
        ...
        },
        {
          ...
          count: "11 ORGANIZATIONS",
          description: "Collective professional experience across AI labs, computing platforms, digital products, mobility technology, and global industry.",
          items: [
            "OpenAI",
            "Google DeepMind",
            "NVIDIA",
    ...
    mentors: {
      ...
      groups: [
        ...
        },
        {
          ...
          title: "前沿科技与产业",
          count: "11 ORGANIZATIONS",
          description: "汇集 AI 实验室、计算平台、数字产品、智能出行与全球产业的集体职业经历。",
          items: ["OpenAI", "Google DeepMind", "NVIDIA", "Meta", "Microsoft", "LinkedIn", "Tesla", "TikTok", "Uber", "Waymo", "复星"],
        },
      ],
